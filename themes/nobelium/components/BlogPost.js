...
return (
  <article
    className={`${showPageCover ? 'flex md:flex-row flex-col-reverse' : ''} replace mb-12 order-b border-dotted border-gray-300 dark:border-gray-600 gap-4  items-stretch pb-[2.5rem] border-b border-dotted border-gray-300 dark:border-gray-600`}>
          {/* 图片封面 */}
    {showPageCover && (
